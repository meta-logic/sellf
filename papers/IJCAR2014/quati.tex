...
% TODO: change the directory path for the release
{\footnotesize
\begin{verbatim}
...
%% TODO: describe the functionalities:
...
% TODO: fix this table one everything is there.
\begin{figure}[t]
\begin{align*}
...
%A Quati program consists of three parts: (1) the term and kind declarations,
%specifying the constants in the $Term$ set; (2) the 
...
% TODO: explain the division into rule types???
{\footnotesize
\begin{verbatim}
%%%%%%%%%%%%%%%%%%%%%%%%%% Bipoles %%%%%%%%%%%%%%%%%%%%%%%%%%%
% Implication
