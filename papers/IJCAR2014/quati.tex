...
Under the hood, Quati is using the focusing discipline constructing the focused derivation that introduces such 
a SELL bipole. This can be observed by using the command \texttt{bipole}. For the same SELL bipole, Quati returns
...
\cite{nigam09ppdp}. The basic data structure is linear logic formulas,
